...
public class SimulatedNaukriAutomationClient implements NaukriAutomationClient {
    ...
    @Override
    public int applyToMatchingJobs(NaukriCredentials credentials, JobSearchCriteria criteria) {
        ...
        return Math.min(criteria.applicationsToSubmit(), maxLikelyApplications);
    }
}
